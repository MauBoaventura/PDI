...
% image.
clc;
f = imread('C:\Users\Maurício\Downloads\10 Periodo\Processamento Digital de Imagem\2019.1 Mauricio\Imagens Trabalho PDI\Gato Preto e Branco.bmp');
figure
...
r = imnoise2('salt & pepper',M,N,0.1,0.2);
figure
